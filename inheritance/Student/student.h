...
class Student
{
    ...
    private: //if the method is private, the derived class cant access directly to this member. If change the method to protected, the derived class can be access directly to this member
